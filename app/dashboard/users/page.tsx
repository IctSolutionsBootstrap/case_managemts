...
const roleIcons: Record<string, React.ReactNode> = {
  ...
  bureau: <Building className="h-4 w-4" />,
...
export default function UsersPage() {
  ...
  useEffect(() => {
    ...
    // Only bureau and document_officer can manage users
    if (!isLoading && user && !['bureau', 'document_officer'].includes(user.role)) {
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center">
                  ...
                  <Select value={roleFilter} onValueChange={setRoleFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="bureau">Bureau Admin</SelectItem>
