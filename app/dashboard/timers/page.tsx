        ...
        <Card className="border-red-300">
          ...
          <CardContent className="space-y-4">
            {violatedTimers.map((timer, index) => (
              <div key={`${timer.caseId}-${timer.timerType}-${index}`} className="rounded-lg border border-red-200 bg-red-50 p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge variant="destructive">{timer.timerType.replace(/_/g, ' ')}</Badge>
                </div>
        ...
        <Card className="border-orange-300">
          ...
          <CardContent className="space-y-4">
            {urgentTimers.map((timer, index) => (
              <div key={`${timer.caseId}-${timer.timerType}-${index}`} className="rounded-lg border border-orange-200 bg-orange-50 p-4">
                <div className="flex items-center justify-between mb-2">
                  <div>
                  ...
                  <Badge className="bg-orange-600">{timer.timerType.replace(/_/g, ' ')}</Badge>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {allTimers.filter(t => !t.isViolated).map((timer, index) => (
            <div key={`${timer.caseId}-${timer.timerType}-${index}`} className="rounded-lg border p-4">
              <div className="flex items-center justify-between mb-2">
                <div>
                ...
                <div className="flex items-center gap-2">
                  <Badge variant="outline">{timer.timerType.replace(/_/g, ' ')}</Badge>
